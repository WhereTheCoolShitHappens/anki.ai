//
// ProductsMasterViewController.swift
// AnkiAi-iOS
//
...
class ProductsMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "ProductMasterViewConterollerLogger")
    ...
    func requestEntities(completionHandler: @escaping (Error?) -> Void) {
        ...
        self.northwindEntities.fetchProducts(matching: query) { products, error in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ProductsDetailViewController
...
extension ProductsMasterViewController: EntitySetUpdaterDelegate {
