...
class CellCreationHelper {
    ...
    static func cellForDefault(tableView: UITableView, indexPath: IndexPath, editingIsAllowed: Bool = false) -> FUISimplePropertyFormCell {
    ...
    private static func formCellWithEditableContent(tableView: UITableView, indexPath: IndexPath, property: Property, with value: String, editingIsAllowed: Bool = true, changeHandler: @escaping ((String) -> Bool)) -> FUISimplePropertyFormCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: FUISimplePropertyFormCell.reuseIdentifier, for: indexPath) as! FUISimplePropertyFormCell
    ...
    private static func formCellWithNonEditableContent(tableView: UITableView, indexPath: IndexPath, for key: String, with value: String) -> FUISimplePropertyFormCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: FUISimplePropertyFormCell.reuseIdentifier, for: indexPath) as! FUISimplePropertyFormCell
        cell.keyName = key
        cell.value = value
