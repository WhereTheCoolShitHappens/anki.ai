//
// CategorySalesFor1997MasterViewController.swift
// AnkiAi-iOS
//
...
class CategorySalesFor1997MasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private var entities: [CategorySalesFor1997] = [CategorySalesFor1997]()
    private let logger = Logger.shared(named: "CategorySalesFor1997MasterViewConterollerLogger")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let categorysalesfor1997 = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CategoryName", value: "\(categorysalesfor1997.categoryName!)")
        return cell
    }
    ...
    func requestEntities(completionHandler: @escaping (Error?) -> Void) {
        ...
        self.northwindEntities.fetchCategorySalesFor1997(matching: query) { categorySalesFor1997, error in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! CategorySalesFor1997DetailViewController
...
extension CategorySalesFor1997MasterViewController: EntitySetUpdaterDelegate {
