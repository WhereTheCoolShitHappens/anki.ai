//
// SalesTotalsByAmountsDetailViewController.swift
// AnkiAi-iOS
//
...
class SalesTotalsByAmountsDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "SalesTotalsByAmountsMasterViewControllerLogger")
    ...
    func createEntityWithDefaultValues() -> SalesTotalsByAmount {
        ...
        newEntity.orderID = CellCreationHelper.defaultValueFor(SalesTotalsByAmount.orderID)
        newEntity.companyName = CellCreationHelper.defaultValueFor(SalesTotalsByAmount.companyName)
...
extension SalesTotalsByAmountsDetailViewController: EntityUpdaterDelegate {
