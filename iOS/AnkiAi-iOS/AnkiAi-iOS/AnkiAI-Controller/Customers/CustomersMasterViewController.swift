//
// CustomersMasterViewController.swift
// AnkiAi-iOS
//
...
class CustomersMasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "CustomerMasterViewConterollerLogger")
    ...
    func requestEntities(completionHandler: @escaping (Error?) -> Void) {
        ...
        self.northwindEntities.fetchCustomers(matching: query) { customers, error in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! CustomersDetailViewController
...
extension CustomersMasterViewController: EntitySetUpdaterDelegate {
