//
// ProductSalesFor1997MasterViewController.swift
// AnkiAi-iOS
//
...
class ProductSalesFor1997MasterViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private var entities: [ProductSalesFor1997] = [ProductSalesFor1997]()
    private let logger = Logger.shared(named: "ProductSalesFor1997MasterViewConterollerLogger")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let productsalesfor1997 = self.entities[indexPath.row]
        let cell = CellCreationHelper.objectCellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CategoryName", value: "\(productsalesfor1997.categoryName!)")
        return cell
    }
    ...
    func requestEntities(completionHandler: @escaping (Error?) -> Void) {
        ...
        self.northwindEntities.fetchProductSalesFor1997(matching: query) { productSalesFor1997, error in
    ...
    override func prepare(for segue: UIStoryboardSegue, sender _: Any?) {
        if segue.identifier == "showDetail" {
            ...
            let detailViewController = segue.destination as! ProductSalesFor1997DetailViewController
...
extension ProductSalesFor1997MasterViewController: EntitySetUpdaterDelegate {
