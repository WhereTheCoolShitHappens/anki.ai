//
// RegionsDetailViewController.swift
// AnkiAi-iOS
//
...
class RegionsDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "RegionsMasterViewControllerLogger")
    ...
    func createEntityWithDefaultValues() -> Region {
        ...
        newEntity.regionID = CellCreationHelper.defaultValueFor(Region.regionID)
        newEntity.regionDescription = CellCreationHelper.defaultValueFor(Region.regionDescription)
...
extension RegionsDetailViewController: EntityUpdaterDelegate {
