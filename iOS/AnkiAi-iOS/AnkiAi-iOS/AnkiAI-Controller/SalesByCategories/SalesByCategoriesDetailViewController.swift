//
// SalesByCategoriesDetailViewController.swift
// AnkiAi-iOS
//
...
class SalesByCategoriesDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "SalesByCategoriesMasterViewControllerLogger")
    ...
    func createEntityWithDefaultValues() -> SalesByCategory {
        ...
        newEntity.categoryID = CellCreationHelper.defaultValueFor(SalesByCategory.categoryID)
        newEntity.categoryName = CellCreationHelper.defaultValueFor(SalesByCategory.categoryName)
        newEntity.productName = CellCreationHelper.defaultValueFor(SalesByCategory.productName)
...
extension SalesByCategoriesDetailViewController: EntityUpdaterDelegate {
