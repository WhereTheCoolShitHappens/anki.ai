//
// ShippersDetailViewController.swift
// AnkiAi-iOS
//
...
class ShippersDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private let logger = Logger.shared(named: "ShippersMasterViewControllerLogger")
    ...
    private func cellForShipperID(tableView: UITableView, indexPath: IndexPath, currentEntity: Shipper, property: Property) -> UITableViewCell {
        var value = ""
        value = currentEntity.shipperID != nil ? "\(currentEntity.shipperID!)" : ""
    ...
    func createEntityWithDefaultValues() -> Shipper {
        ...
        newEntity.shipperID = CellCreationHelper.defaultValueFor(Shipper.shipperID)
        newEntity.companyName = CellCreationHelper.defaultValueFor(Shipper.companyName)
...
extension ShippersDetailViewController: EntityUpdaterDelegate {
